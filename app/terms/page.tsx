...
export const metadata: Metadata = {
    title: '이용약관 | 은퇴 자산 계산기',
    description: '은퇴 자산 계산기 서비스 이용약관입니다.',
};
        ...
        <div className="max-w-4xl mx-auto px-6 py-12">
            ...
            <div className="prose prose-slate max-w-none text-sm text-slate-600 space-y-6">
                <section>
                    ...
                    <p>
                        본 약관은 '은퇴 자산 계산기' (이하 "회사")가 제공하는 서비스(이하 "서비스")의 이용조건 및 절차, 회사와 회원의 권리, 의무 및 책임사항 등 기타 필요한 사항을 규정함을 목적으로 합니다.
                    </p>
                </section>
                <section>
