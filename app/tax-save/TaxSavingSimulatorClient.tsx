...
export default function TaxSavingSimulatorClient() {
    ...
    const formatAxisY = (value: number) => {
        ...
        const maxBalance = Math.max(...result.yearlyData.map(d => Math.max(d.amountSaving, d.amountGeneral)));
