...
export const metadata: Metadata = {
    title: '개인정보처리방침 | 은퇴 계산기',
    description: '은퇴 계산기 서비스 개인정보처리방침입니다.',
};
        ...
        <div className="max-w-4xl mx-auto px-6 py-12">
            ...
            <div className="prose prose-slate max-w-none text-sm text-slate-600 space-y-6">
                <section>
                    ...
                    <p>
                        '은퇴 계산기'는(은) 다음의 목적을 위하여 개인정보를 처리합니다. 처리하고 있는 개인정보는 다음의 목적 이외의 용도로는 이용되지 않으며 이용 목적이 변경되는 경우에는 「개인정보 보호법」 제18조에 따라 별도의 동의를 받는 등 필요한 조치를 이행할 예정입니다.
                    </p>
